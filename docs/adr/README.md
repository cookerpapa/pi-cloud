...
1. [ADR-0124](0124-opaque-execution-grant-sequencer.md) — one opaque,
   never-reused ExecutionGrant across Worker, events, SessionStorage and Tools.
2. [ADR-0123](0123-isolated-preview-origins.md) — target-scoped capabilities
   and independent browser origins for untrusted application Preview.
3. [ADR-0122](0122-jetstream-event-authority.md) — R=3 JetStream, batched
   Run capability validation, committed live fanout and Session mutation projection.
4. [ADR-0120](0120-exclusive-full-vm-authority.md) — exclusive Cube full-VM
   state, restart adoption and the elastic/exclusive durability split.
5. [ADR-0118](0118-session-workspace-environment-and-ssh.md) — independent
