...
2. [ADR-0122](0122-jetstream-event-authority.md) — R=3 JetStream, batched
   Run capability validation, committed live fanout and Session mutation projection.
3. [ADR-0120](0120-exclusive-full-vm-authority.md) — exclusive Cube full-VM
   state, restart adoption and the elastic/exclusive durability split.
4. [ADR-0118](0118-session-workspace-environment-and-ssh.md) — independent
   Session/Workspace/compute lifetimes, exclusive Cube handoff and SSH access.
5. [ADR-0117](0117-persistent-terminal-preview-and-development-profiles.md) —
