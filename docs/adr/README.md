...
1. [ADR-0121](0121-opaque-preview-subresource-authority.md) — short-lived,
   target-scoped authority for subresources inside an opaque Preview origin.
2. [ADR-0120](0120-exclusive-full-vm-authority.md) — exclusive Cube full-VM
   state, restart adoption and the elastic/exclusive durability split.
3. [ADR-0119](0119-kafka-native-batching-and-session-projection-barriers.md) —
...
5. [ADR-0117](0117-persistent-terminal-preview-and-development-profiles.md) —
   ...
   environments.
6. [ADR-0116](0116-kafka-first-agent-event-log.md) — Kafka-first hot Agent
