...
| UI-02 | Logout silently treats network failure as success and leaves machine/dialog state in the mounted app | Candidate auth-lifetime leak; reproduce delayed old-tenant responses during account change and make logout completion truthful |
